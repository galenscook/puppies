...
# be available. To handle this, rescue the LoadError.+# https://devcenter.com/articles/getting-started-with-ruby-o#runtime-dependencies-on-development-test-gems
